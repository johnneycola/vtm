...
## Стандартный экран say заменён кастомным в chat_ui.rpy (лента диалога).
...
## Стандартный экран choice заменён кастомным в chat_ui.rpy —
## варианты ответа показываются в зарезервированной зоне внизу ленты.
